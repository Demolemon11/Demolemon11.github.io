...
## Ongoing tasks:
Trying to complete the account & appearance content.

## Difficulties:
How to coding the `Widget` trait Glancelly if I wanna add some actual actions for inputting username & setting theme?

## WorkInsights:
I deeply hold the belief that Robrix will be a great project right now!!
